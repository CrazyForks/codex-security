...
const nestedDirectoryScanProbe = [
  ...
  "    matching_reads = []",
  "    for label, path in [('forgedOriginMatching', forged_clone), ('relatedCheckoutMatching', related_clone), ('reusedCheckoutMatching', reused_checkout), ('movedCheckoutMatching', moved_checkout)]:",
  ...
  "    for label, path in [('forgedTargetlessIdentity', forged_clone), ('relatedTargetlessIdentity', related_clone)]:",
