...
const nestedDirectoryScanProbe = [
  ...
  "from workbench_scan_history import list_scans, list_unmatched_scan_pairs",
  ...
  "    matching_args = argparse.Namespace(repository=str(forged_clone), force=False)",
  "    matching = list_unmatched_scan_pairs(connection, matching_args, backfill_finding_details=lambda *_: None, read_coverage=lambda _: {})",
  "    output['forgedOriginMatchingScans'] = matching['scanCount']",
