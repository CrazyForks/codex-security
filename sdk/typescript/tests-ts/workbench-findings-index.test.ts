...
const nestedDirectoryScanProbe = [
  ...
  "    matching_reads = []",
  "    for label, path in [('forgedOriginMatching', forged_clone), ('forgedGitDirectoryMatching', forged_git_directory), ('relatedCheckoutMatching', related_clone), ('reusedCheckoutMatching', reused_checkout), ('movedCheckoutMatching', moved_checkout)]:",
