...
untracked/ignored files, submodule contents, symlinks, hard-linked source/plugin files, unstaged deletions,
...
closed. Use Codex for paths containing only untracked or ignored files. Inputs
