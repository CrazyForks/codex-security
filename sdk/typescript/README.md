...
deletions, sparse-checkout paths absent from the worktree, common local credential stores/key material (including `.config`, `.envrc`, `.bundle`, and Terraform state), Git credentials/history (including tracked nested bare repositories),
